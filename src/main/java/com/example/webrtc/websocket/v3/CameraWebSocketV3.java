package com.example.webrtc.websocket.v3;
...
@Slf4j
@Component
@ServerEndpoint("/v3/camera")
public class CameraWebSocketV3 {

    private static final AtomicInteger cameraNum = new AtomicInteger(0);
    private static final ConcurrentMap<String, CameraWebSocketV3> users = new ConcurrentHashMap<>();
